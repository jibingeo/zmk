...
static struct iqs5xx_data iqs5xx_data = {.i2c = DEVICE_DT_GET(DT_BUS(DT_DRV_INST(0))),
...
K_THREAD_DEFINE(thread, 1024, iqs5xx_thread, DEVICE_DT_GET(DT_DRV_INST(0)), NULL, NULL,
                K_PRIO_COOP(10), 0, 0);
